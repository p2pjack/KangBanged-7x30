...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 0, MAX_AXI_KHZ, AXI, 1, 0,  61440000,  850, VDD_RAW(850) },
        { 1, 122880, PLL_3,    5, 2,  61440000,  850, VDD_RAW(850) },
	{ 1, 245760, PLL_3,    5, 2,  122800000, 875, VDD_RAW(875) },
	{ 1, 368640, PLL_3,    5, 1,  122800000, 900, VDD_RAW(900) },
	/* AXI has MSMC1 implications. See above. */
        { 1, 491520, PLL_1,    2, 0,  153600000, 950, VDD_RAW(950) },
	...
	{ 1, 806400,  PLL_2, 3, 0, 192000000, 1100, VDD_RAW(1100), &pll2_tbl[0]},
        { 1, 929280,  PLL_2, 3, 0, 192000000, 1150, VDD_RAW(1150), &pll2_tbl[1]},
	{ 1, 1024000, PLL_2, 3, 0, 192000000, 1175, VDD_RAW(1175), &pll2_tbl[2]},
        { 1, 1146680, PLL_2, 3, 0, 192000000, 1200, VDD_RAW(1200), &pll2_tbl[3]},
	{ 1, 1200000, PLL_2, 3, 0, 192000000, 1200, VDD_RAW(1200), &pll2_tbl[4]},
        { 1, 1322880, PLL_2, 3, 0, 192000000, 1225, VDD_RAW(1225), &pll2_tbl[4]},
